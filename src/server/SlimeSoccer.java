...
public class SlimeSoccer {
    ...
    BallCaretaker ballCaretaker = new BallCaretaker();
    ...
    public void tick() {
        ...
        if (Window.saveBall) {
            ballCaretaker.saveCheckpoint(ball);
            Window.saveBall = false;
        }
        if (Window.restoreBall) {
            ballCaretaker.restoreCheckpoint(ball);
            Window.restoreBall = false;
        }
