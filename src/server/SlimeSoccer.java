...
public class SlimeSoccer {
    ...
    private GameCheckHandler gameEventHandler;
    ...
    public void init() {
        ...
        GameCheckHandler leftFoul = new LeftFoulHandler();
        GameCheckHandler rightFoul = new RightFoulHandler();
        GameCheckHandler leftGoal = new LeftGoalHandler();
        GameCheckHandler rightGoal = new RightGoalHandler();

        leftFoul.setNext(rightFoul);
        rightFoul.setNext(leftGoal);
        leftGoal.setNext(rightGoal);

        this.gameEventHandler = leftFoul;
    }
    ...
    public void tick() {
        ...
        player3.floorCheck();
        player3.gravity();
        if (player3.foulCheckRight() || player4.foulCheckRight() || player3.foulCheckLeft()
                || player4.foulCheckLeft()) {
        ...
        GameEventContext context = new GameEventContext(
                ball, leftErrorBar, rightErrorBar, leftGoal, rightGoal);
        gameEventHandler.check(context, this);
    }
    ...
    // Callbacks for Chain Handlers
    public void handleFoul(boolean isLeft) {
        if (isLeft) {
            if (gamestate == 1)
                player2Score++;
        } else {
    ...
    public void handleGoal(boolean isLeft) {
        if (isLeft) {
            if (gamestate == 1)
                player2Score++;
        } else {
