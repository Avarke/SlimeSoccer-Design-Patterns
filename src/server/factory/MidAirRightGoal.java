...
public class MidAirRightGoal extends Goal {
    public MidAirRightGoal(double x, double y, boolean isLeft) {
        super(x, y, isLeft);
    }
    ...
    public void draw(Graphics g) {
        ...
        g.fillRect((int)x, (int)(y - 5), 6, (int)height);
    }
}
